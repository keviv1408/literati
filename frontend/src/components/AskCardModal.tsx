                ...
                return (
                  <button
                    ...
                    className={[
                      ...
                      'text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400',
                      'active:scale-[0.98]',
                      isSelected
                  ...
                  >
                    ...
                    <div
                      className={[
                        ...
                        player.teamId === 1 ? 'bg-emerald-700 text-emerald-100' : 'bg-violet-700 text-violet-100',
                      ].join(' ')}
                    >
