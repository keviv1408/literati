...
export default function LastMoveDisplay({
  ...
  return (
    <div
      className="relative z-10 flex items-center justify-center px-4 py-2 bg-slate-100/95 border-b border-slate-300/90 text-sm sm:text-base text-slate-800 font-medium shadow-sm"
      aria-live="polite"
